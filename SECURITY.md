...
We aim to support the latest stable release of Bolt Spring Boot Starter and provide critical security patches as needed.
...
If you discover a security vulnerability in Bolt Spring Boot Starter, please report it responsibly:

**Please DO NOT report security vulnerabilities through public GitHub issues, pull requests, or discussions.**

Instead, please report via:
- **GitHub Security Advisories**: https://github.com/jwcarman/bolt-spring-boot/security/advisories/new (preferred)
